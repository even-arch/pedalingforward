    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { _key: "b2", title: ls("Demand aggregation","需求聚合","需要の集約","Nachfragebündelung"), body: lt("Orders come in as a group buy, not one small purchase at a time. You set the price, MOQ, and lead time. We handle the buyer side.","訂單以團購形式進來，不是一次一點。你決定售價、最低起訂量和交期，我們負責買家端。","注文は少量ずつではなくグループバイとしてまとまって入ってくる。","Bestellungen kommen als Gruppenbestellung. Sie legen Preis, MOQ und Lieferzeit fest.") },
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          { _key: "p2", text: lt("Payment is local. Delivery is door-to-door. No freight forwarding, no customs brokerage on your end.","當地幣別付款。直送到府。不需要自行安排貨運或辦理通關。","支払いは現地通貨。配送はドアツードア。","Zahlung in lokaler Währung. Haustürlieferung. Keine Spedition, keine Zollabfertigung Ihrerseits.") },
        ],
      },
      {
        _key: "benefits", _type: "benefitsSection",
